export default {
  ...
  roles: {
    ...
    subtitle: 'Manage custom roles and permissions for this workspace.',
    create: 'New Role',
    ...
    upgradeNotice:
      'Custom Roles is an Enterprise feature. Upgrade your plan to create custom roles.',
    createTitle: 'Create Role',
    editTitle: 'Edit Role',
    name: 'Role name',
    namePlaceholder: 'e.g. reviewer, editor...',
    description: 'Description',
  ...
  labels: {
    ...
    save: 'Save',
    cancel: 'Cancel',
    namePlaceholder: 'e.g. Bug, Feature, Urgent...',
    taskLabels: 'Labels',
